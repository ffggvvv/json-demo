...
Runner.prototype = {
    ...
    init: function (elem) {
       ...
       camera.position.z = 750
        //雾化
       scene.fog = new FogExp2(0x05010c, 0.00025, 1000)
    ...
    console.log(fbxLoader,"three");
        ...
        fbxLoader.load(
            ...
            function ( object ) {
                ...
                // object.vertices = []
                // let offset = 0;
                // let zLength = object.children[0].geometry.attributes.position.array.length;
                // console.log(zLength);
                // while (offset < zLength) {
                // let vertex = new Vector3();
  
                // vertex.x = object.children[0].geometry.attributes.position.array[offset++] * scale;
                // vertex.y = object.children[0].geometry.attributes.position.array[offset++] * scale;
                // vertex.z = object.children[0].geometry.attributes.position.array[offset++] * scale;
                // console.log(123);
                // object.vertices.push(vertex);
                // console.log(vertex.x,"x");
                // }
        ...
        // fbxLoader.load('json/1223.fbx', (geo) => {
    ...
    changeModel: function (index) {
        console.log(glist,"ge");
        geometry.vertices.forEach((vtx, i) => {
            console.log(vtx.tweenvtx,i);
